...
export default function Home() {
    return (
        <section className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-indigo-950 pt-28 overflow-hidden">
            {/* Glow */}
            <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-indigo-600/20 rounded-full blur-3xl" />
            <div className="absolute top-1/2 -right-40 w-[700px] h-[500px] bg-purple-600/20 rounded-full blur-3xl" />

            <div className="relative max-w-7xl mx-auto px-6 md:px-10 flex items-center min-h-[calc(100vh-7rem)]">
